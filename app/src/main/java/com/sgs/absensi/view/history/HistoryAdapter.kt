package com.sgs.absensi.view.history
...
import com.sgs.absensi.utils.BitmapManager.base64ToBitmap
...
class HistoryAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvStatusAbsen.text = data.tipe_absen
        holder.tvKetnya.text = data.keterangan
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val tvKetnya: TextView = itemView.tvKetnya
